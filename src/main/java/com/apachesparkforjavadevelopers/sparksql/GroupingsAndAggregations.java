...
public class GroupingsAndAggregations {
    public static void main(String[] args) {
        ...
        dataset.createOrReplaceTempView("log_messages");

        spark.sql("select level, collect_list(datetime) as datetime_lst from log_messages group by level").show(false);
